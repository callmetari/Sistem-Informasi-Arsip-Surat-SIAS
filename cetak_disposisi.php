<title>Lembar Arsip Surat</title>
<?php
	include 'koneksi.php';
...
?>
	...
	<div class="row" align="center">
		<div class="header">
			...
			<h6 class="text">PEMERINTAH KABUPATEN X <br> KECAMATAN Y <br> KEPALA DESA KARANGDUREN</h6>
			<h4>Jl. Merdeka No. 29, Tlp. (0322) 392994, E-mail: pemdeskarangduren@yahoo.com</h4>
			<td colspan="3" bordered="#000000">
				<div align="center" style="border: solid; font-size: 20px;">
					DESA KARANGDUREN
				</div>
			</td>
		</div>
		...
		<table cellspacing="0" cellspacing="5" >
			...
			?>
				<tr>
					<td class="tgh" ="tgh" id="lbr" colspan="5">LEMBAR ARSIP SURAT</td>
				</tr>
				<tr>
				...
				<tr>
					<td id="right" width="200"><strong> No. Surat :</strong></td>
